...
using todostiv.Common.Models;
using todostiv.Common.Responses;
using todostiv.Functions.Entities;

namespace todostiv.Functions.Function
{
    public static class TodoApi
    {
        ...
        public static async Task<IActionResult> DeleteTodo(
          ...
          ILogger log)
        {
            log.LogInformation($"Delete todo: {id}, recieved.");
